...
- [x] **Phase 2: Price History** - Daily price snapshots, automatic tracking, real charts on web and mobile (completed 2026-04-21)
- [x] **Phase 3: Notifications & Admin** - Email alerts on price drops + admin dashboard with real stats (completed 2026-04-21)
...
- [x] 01-02: Build fuzzy product matching to group same products across stores
- [x] 01-03: Multi-vendor product page with side-by-side store listings and Best Value badge
...
Plans:
- [x] 02-01: Create price_history table in Supabase and integrate snapshot recording into scraper pipeline
- [x] 02-02: Build backend API endpoint for fetching price history by product URL
- [x] 02-03: Replace chart placeholders with real data on web and mobile product pages
...
Plans:
- [x] 03-01: Set up email service (Resend/SendGrid) and integrate with alert checker to send price drop emails
- [x] 03-02: Add notification_sent tracking to prevent duplicate emails
- [x] 03-03: Implement admin role-based auth and build real stats backend endpoint
- [x] 03-04: Wire admin dashboard UI to the real stats endpoint
...
Plans:
- [ ] 04-01: Wire mobile trending and recently viewed to backend APIs (adds backend-persisted recently_viewed)
- [ ] 04-02: Sync mobile wishlist with backend API (bidirectional)
- [ ] 04-03: Integrate mobile price alerts with backend API (create, list, delete; enriched list)
...
|-------|----------------|--------|-----------|
| 1. Product Experience | 3/3 | Complete    | 2026-04-21 |
| 2. Price History | 3/3 | Complete    | 2026-04-21 |
| 3. Notifications & Admin | 4/4 | Complete    | 2026-04-21 |
