...
export const Logo: React.FC<LogoProps> = ({ size = 'md', showText = true }) => {
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
      <svg width={dimensions[size]} height={dimensions[size] * 1.22} viewBox="0 0 231 281">
        <g>
          <path
            fill="var(--accent)"
      ...
      {showText && (
        <span style={{
          ...
          <span style={{ color: 'var(--text-main)' }}>HAO</span>
          <span style={{ color: 'var(--text-3)', fontWeight: 400 }}>.PK</span>
        </span>
      )}
    </div>
  );
